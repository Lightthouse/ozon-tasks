...
work_time = max(input_tasks, key=lambda x: x[0])[0]

processes_loading = {proc: 0 for proc in sorted(input_processors)}
tasks_dict = {time: duration for time, duration in input_tasks}
total_energy = 0
