...
from sandbox_tasks import products_sum
...
def _test_task_on_file(test_num: int):
    ...
    for nums_list in request:
        calculate_result.append(products_sum(nums_list))
