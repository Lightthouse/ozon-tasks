...
from sandbox_tasks import calculate_tasks_completing_time
...
def _get_mock_request_data(request_file: str):
    ...
    return tasks, processors, processors_count
...
def _test_task_on_file(test_num: int):
    ...
    tasks, processors, processors_count = _get_mock_request_data(request_file)
